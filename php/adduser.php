...
if(isset($_POST['but_submit']))
{
    ...
    $result = $conn->query("SELECT id FROM accounts WHERE username='$login'");
    ...
    if($working == true)
    {
        $reg="INSERT INTO accounts (username, email, password) Values('$login','$email','$passwd')";
