<?php
require("connect.php");
$query = "SELECT COUNT(*) as numberPosts FROM recipes";
$countresult = $conn->query($query);
$fetchnumberPosts = $countresult->fetch_array();
$numberPosts = $fetchnumberPosts['numberPosts'];
$losuj =rand ( 8 , $numberPosts+8 );
$query = "SELECT * FROM recipes WHERE recipes.id=".$losuj;
...
{    
    ...
    echo '<a href="php/recipe.php?q='.$id.'" style="text-decoration: none;">';  
    echo $nazwa; 
    echo '</a>';
    echo '</div>';
    echo '<div class="row">';
